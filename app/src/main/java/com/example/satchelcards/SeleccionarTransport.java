...
public class SeleccionarTransport extends ClassBlockOrientation {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.seleccionar_transport);

        imagen = findViewById(R.id.imagen_tarjeta);
        nombreTarjeta = findViewById(R.id.nombre_tarjeta_access);
        nombreTitular = findViewById(R.id.nombre_titular_access);
        ...
        DocumentReference userRef = db.collection("user").document(email).collection("transport").document(itemId);
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SeleccionarTransport.this, AddTransport.class);
