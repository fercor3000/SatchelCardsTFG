    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_guardar.setOnClickListener(new View.OnClickListener() {
            ...
            private void insertInDDBB(String cardName, String cardHolderName, Date DExpire, String userCardID, String cardNextId) {
                ...
                //Me situo en una coleccion inexistente en user/email/loyalty/userCardID y se crea automaticamente cuando intento insertar datos ahí.
                DocumentReference docRef = db.collection("user").document(email).collection("loyalty").document(userCardID);
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        if (selectedImageUri != null) {
                            FirebaseStorage storage = FirebaseStorage.getInstance();
                            StorageReference storageRef = storage.getReference();
                            StorageReference imagenRef = storageRef.child("cardImages/" + currentUser.getUid() + "_loyalty_" + itemId);
